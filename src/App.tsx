    ...
    <>
      <header className="container-fluid mb-3 mb-md-0">
        ...
        <div className="d-md-flex justify-content-between">
          <div className="col-8 col-lg-3 d-none d-md-block top-stitch rounded-bottom">
      ...
      <div className="jumbotron-fluid position-relative top-image p-0">
        {/* <!-- ロゴ --> */}
        <div className="logo-mark bg-dark position-absolute">
          <img
              ...
              <div className="card mb-4 border border-0">
                ...
                <div className="card-body">
                  ...
                  <div className="text-center">
                    <a
                      className="btn btn-outline-secondary d-block d-md-inline-block mb-2 mb-md-0"
      ...
      <div className="accsess pt-2">
        ...
        {/* <!-- 地図 --> */}
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d12963.312118305756!2d139.7671248!3d35.6812362!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x277c49ba34ed38!2z5p2x5Lqs6aeF!5e0!3m2!1sja!2sjp!4v1559551150824!5m2!1sja!2sjp" title="map"></iframe>
      </div>
