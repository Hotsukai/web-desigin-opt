...
function App() {
  const [mainColor, setMainColor] = useState("#a9a9a9");
  const [subColor, setSubColor] = useState("#343a40");
            ...
            <div className="card mb-4 border border-0">
              ...
              <div className="card-body">
                ...
                <div className="text-center">
                  <a
                    className="btn btn-outline-secondary d-block d-md-inline-block mb-2 mb-md-0 bg-sub"
